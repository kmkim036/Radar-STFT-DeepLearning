...
def preprocessing(person):  # person, motion에 해당하는 image 불러옴
    ...
    image = np.zeros(shape=(count * 2, rows, cols, 1))
    label = []
...
image3, label3 = preprocessing(3)  # 여성1_motion 불러옴
image4, label4 = preprocessing(4)  # 여성2_motion 불러옴
