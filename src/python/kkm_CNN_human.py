...
def concatenate_n_div(image0, label0, image1, label1, image2, label2, image3, label3):
    ...
    x_train = np.concatenate((image0[0:int(count*train_ratio)],
                              image1[0:int(count*train_ratio)],
                              image2[0:int(count*train_ratio)],
                              image3[0:int(count*train_ratio)]))
    y_train = np.concatenate((label0[0:int(count*train_ratio)],
...
image1, label1 = preprocessing(1)  # 남성1 불러옴
image2, label2 = preprocessing(2)  # 남성2 불러옴
image3, label3 = preprocessing(3)  # 여성1 불러옴
image4, label4 = preprocessing(4)  # 여성2 불러옴
