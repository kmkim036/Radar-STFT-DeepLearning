...
for i in range(try_num):
    ...
    x_train, y_train, x_val, y_val, x_test, y_test = concatenate_n_div(
        image1_shuff, label1, image2_shuff, label2, image3_shuff, label3, image4_shuff, label4, image5_shuff, label5, image6_shuff, label6, image7_shuff, label7, image8_shuff, label8, image9_shuff, label9, image10_shuff, label10, image11_shuff, label11, image12_shuff, label12)
