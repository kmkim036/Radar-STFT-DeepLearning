...
def preprocessing(person, motion): 
...
image1, label1 = preprocessing(1, motion)  
image2, label2 = preprocessing(2, motion)  
image3, label3 = preprocessing(3, motion)  
image4, label4 = preprocessing(4, motion) 
